 ...
 */
final class Version20221207191838 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE notification.notification (id UUID NOT NULL, status VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, details_notification JSONB NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN notification.notification.id IS \'(DC2Type:uuid)\'');
